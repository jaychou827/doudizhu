package com.hefeishifan.domain;
...
public class Poker extends JLabel implements MouseListener {
	...
	public void turnFront() {
		this.setIcon(new ImageIcon("D:\\JavaCode\\doudizhu\\image\\poker\\" + name + ".png"));
		this.up = true;
	}

	//显示背面
	public void turnRear() {
		this.setIcon(new ImageIcon("D:\\JavaCode\\doudizhu\\image\\poker\\rear.png"));
		this.up = false;
	}
